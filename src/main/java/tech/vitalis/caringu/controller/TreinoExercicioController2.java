...
import tech.vitalis.caringu.service.TreinoExercicioService2;

@RestController
@SecurityRequirement(name = "Bearer")
@RequestMapping("/treinos-exercicios")
public class TreinoExercicioController2 {

    private final TreinoExercicioService2 treinoExercicioService;

    public TreinoExercicioController2(
            TreinoExercicioService2 treinoExercicioService
    ) {
