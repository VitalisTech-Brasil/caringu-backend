...
class TreinoExercicioServiceTest {
    ...
    void cadastrarComVariosExercicios_Sucesso() {
        ...
        when(requestDTO.treinoId()).thenReturn(treinoId);
        ...
        treinoExercicio.setTreinos(treino);
        ...
        when(treinoExercicioRepository.existsByTreinos_IdAndExercicio_Id(treinoId, 10)).thenReturn(false);
        ...
        verify(treinoExercicioRepository, times(1)).existsByTreinos_IdAndExercicio_Id(treinoId, 10);
    ...
    void cadastrarComVariosExercicios_ExercicioJaAssociado() {
        ...
        when(treinoExercicioRepository.existsByTreinos_IdAndExercicio_Id(treinoId, exercicioId)).thenReturn(true);
